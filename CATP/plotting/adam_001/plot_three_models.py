...
files = {
    # "validation-create_model_f_def_no_BN-sgd-0p1-madrid-1-4-85-.csv": "f_big_hard",
    "validation-create_model_f_def_no_BN-sgd-0p1-madrid-1-1-85-.csv": "f_big_easy",
    "validation-create_model_f_shallow_no_BN-sgd-0p1-madrid-1-1-85-.csv": "f_small_easy",
    # "validation-create_model_f_shallow_no_BN-sgd-0p1-madrid-1-4-85-.csv": "f_small_hard",
}




alphas = [1, 0.5] # , 0.1, 0.5]
    ...
    for col in columns:
        ...
        if idx >= 0 :
            ...
            if col != 'epoch':
                ...
                if col in ["MC"]:
                    data[col] = data[col] * scale * scale * 10
                if col in ["IC"]:
                    data[col] = data[col] * scale * 10 # Since we don't use any Data loader in IC computation
...
plt.savefig("image_t_easy.png", dpi=300)
plt.show()
