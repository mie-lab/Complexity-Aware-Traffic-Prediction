...
files = {
         # "validation-create_model_f_big_no_BN-adam-001-london-1-4-85-.csv": "f_big",
        # "validation-create_model_f_def_no_BN-adam-001-london-1-4-85-.csv": "f_mid",
        # "validation-create_model_small_epochs-adam-001-london-1-4-85-.csv":"f_small",
    # "validation-create_model_f_shallow_no_BN-adam-001-london-1-4-85-.csv":"f_shallow",

        "validation-create_model_f_big_no_BN-adam-001-madrid-1-4-85-.csv": "f_big",
        "validation-create_model_f_def_no_BN-adam-001-madrid-1-4-85-.csv": "f_mid",
        "validation-create_model_small_epochs-adam-001-madrid-1-4-85-.csv":"f_small",
        "validation-create_model_f_shallow_no_BN-adam-001-madrid-1-4-85-.csv": "f_shallow",
...
plt.savefig("madrid.png", dpi=300)
plt.show()
